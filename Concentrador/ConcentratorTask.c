...
#define CONCENTRATOR_TASK_PRIORITY   4
...
static void buttonCallback(PIN_Handle handle, PIN_Id pinId)
{
    ...
    CPUdelay(8000*50);
    //int pin1 = PIN_getInputValue(Board_PIN_BUTTON1);
    //int pin2 = PIN_getInputValue(Board_PIN_BUTTON0);

    /*if (!PIN_getInputValue(Board_PIN_BUTTON1))
    {
        ConcentratorRadioTask_nodeSub();
    }
    else if (PIN_getInputValue(Board_PIN_BUTTON0))
    {
        ConcentratorRadioTask_nodeAddr();
    }*/
