...
static uint8_t nodeAddress = 2; /* Node address */
...
static uint8_t dstAddress = 1; /* Destination address */
...
static void sendDmPacket(struct DualModeSensorPacket sensorPacket, uint8_t maxNumberOfRetries, uint32_t ackTimeoutMs)
{
    ...
    dmSensorPacket.humidity1 = 7;
    dmSensorPacket.humidity2 = 8;
    dmSensorPacket.humidity3 = 9;
    dmSensorPacket.humidity4 = 10;
    dmSensorPacket.humidity5 = 11;
    dmSensorPacket.humidity6 = 12;
    dmSensorPacket.temperature = 30;
